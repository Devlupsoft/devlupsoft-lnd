    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-5">
            <div class="about-img">
              <img src="{{ asset('front/img/about.jpg') }}" class="img-fluid" alt="About Learning">
            </div>
          </div>
      ...
      <div class="container-fluid p-0" data-aos="fade-up">
        ...
        <div class="row g-0">
          <div class="col-lg-6 video-play position-relative">
            <a href="https://www.youtube.com/watch?v=DvKDBH7bwbk" class="glightbox play-btn"></a>
          </div>
          <div class="col-lg-6">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                <img src="{{ asset('front/img/features-1.svg') }}" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-2">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="{{ asset('front/img/features-2.svg') }}" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="{{ asset('front/img/features-3.svg') }}" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="{{ asset('front/img/features-4.svg') }}" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-5">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="{{ asset('front/img/features-5.svg') }}" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-6">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="{{ asset('front/img/features-6.svg') }}" alt="" class="img-fluid">
              </div>
            </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="service-item">
              <div class="img">
                <img src="{{ asset('front/img/services-2.jpg') }}" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="400">
            <div class="service-item">
              <div class="img">
                <img src="{{ asset('front/img/services-3.jpg') }}" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="500">
            <div class="service-item">
              <div class="img">
                <img src="{{ asset('front/img/services-4.jpg') }}" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="600">
            <div class="service-item">
              <div class="img">
                <img src="{{ asset('front/img/services-5.jpg') }}" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="700">
            <div class="service-item">
              <div class="img">
                <img src="{{ asset('front/img/services-6.jpg') }}" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
