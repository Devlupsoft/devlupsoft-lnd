...
class UsersTableSeeder extends Seeder
{
    ...
    {
        $password = Hash::make('NeoSoft@2022'); // Default user password

        $d = [

            [
                'name' => 'Devlupsoft L&D',
                'email' => 'lnd@devlupsoft.com',
                'username' => 'devlupsoftlnd',
                'password' => $password,
            ...
            [
                'name' => 'Admin Devlupsoft',
                'email' => 'admin@devlupsoft.com',
                'password' => $password,
                'user_type' => 'admin',
                'username' => 'admin',
                'code' => strtoupper(Str::random(10)),
            ...
            [
                'name' => 'Parent Devlupsoft',
                'email' => 'parent@devlupsoft.com',
                'user_type' => 'parent',
                'username' => 'parent',
                'password' => $password,
                'code' => strtoupper(Str::random(10)),
            ...
            [
                'name' => 'Accountant Devlupsoft',
                'email' => 'accountant@devlupsoft.com',
